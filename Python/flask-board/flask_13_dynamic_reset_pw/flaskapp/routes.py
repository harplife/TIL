...
# a function to save picture for account update
...
def post(post_id):
	# same as .get(), but returns 404 if not exist
...
'''
	# currently gmail smtp requires authentication so...
	# mail.send(msg)
